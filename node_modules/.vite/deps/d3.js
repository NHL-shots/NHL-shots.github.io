...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/blur.js
...
var blur2 = Blur2$1(blurf$1);
var blurImage = Blur2$1(blurfImage$1);
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/count.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/fsum.js
var Adder = class {
	constructor() {
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/array.js
var array$5 = Array.prototype;
var slice$3 = array$5.slice;
array$5.map;
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/constant.js
function constant(x) {
	return () => x;
}
//#endregion
...
function tickSpec$1(start, stop, count) {
	const step = (stop - start) / Math.max(0, count), power = Math.floor(Math.log10(step)), error = step / Math.pow(10, power), factor = error >= e10$2 ? 10 : error >= e5$2 ? 5 : error >= e2$2 ? 2 : 1;
	let i1, i2, inc;
	if (power < 0) {
	...
	if (i2 < i1 && .5 <= count && count < 2) return tickSpec$1(start, stop, count * 2);
	return [
		i1,
		i2,
		inc
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/nice.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/threshold/sturges.js
function thresholdSturges(values) {
	return Math.max(1, Math.ceil(Math.log(count(values)) / Math.LN2) + 1);
}
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/bin.js
function bin() {
	var value = identity$5, domain = extent, threshold = thresholdSturges;
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/threshold/freedmanDiaconis.js
function thresholdFreedmanDiaconis(values, min, max) {
	const c = count(values), d = quantile(values, .75) - quantile(values, .25);
	return c && d ? Math.ceil((max - min) / (2 * d * Math.pow(c, -1 / 3))) : 1;
}
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/threshold/scott.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/merge.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/rank.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/least.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/leastIndex.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/greatestIndex.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/scan.js
function scan(values, compare) {
	const index = leastIndex(values, compare);
	return index < 0 ? void 0 : index;
}
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/shuffle.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/transpose.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/zip.js
function zip() {
	return transpose(arguments);
}
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/every.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/some.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/filter.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/map.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/reduce.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/difference.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/disjoint.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/intersection.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/superset.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/subset.js
function subset(values, other) {
	return superset(other, values);
}
//#endregion
//#region node_modules/d3/node_modules/d3-array/src/union.js
...
Dispatch.prototype = dispatch.prototype = {
	...
	on: function(typename, callback) {
		var _ = this._, T = parseTypenames$4(typename + "", _), t, i = -1, n = T.length;
		if (arguments.length < 2) {
			while (++i < n) if ((t = (typename = T[i]).type) && (t = get$3(_[t], typename.name))) return t;
			return;
		}
		if (callback != null && typeof callback !== "function") throw new Error("invalid callback: " + callback);
		while (++i < n) if (t = (typename = T[i]).type) _[t] = set$3(_[t], typename.name, callback);
...
function namespace_default$3(name) {
	var prefix = name += "", i = prefix.indexOf(":");
	if (i >= 0 && (prefix = name.slice(0, i)) !== "xmlns") name = name.slice(i + 1);
	return namespaces_default$3.hasOwnProperty(prefix) ? {
		space: namespaces_default$3[prefix],
		local: name
	} : name;
}
//#endregion
...
function creator_default$3(name) {
	var fullname = namespace_default$3(name);
...
function none$3() {}
function selector_default$3(selector) {
...
function select_default$10(select) {
	if (typeof select !== "function") select = selector_default$3(select);
...
function selectorAll_default$3(selector) {
...
function selectAll_default$7(select) {
	if (typeof select === "function") select = arrayAll$3(select);
	else select = selectorAll_default$3(select);
...
function matcher_default$3(selector) {
	return function() {
...
function selectChild_default$3(match) {
	return this.select(match == null ? childFirst$3 : childFind$3(typeof match === "function" ? match : childMatcher$3(match)));
}
//#endregion
...
function selectChildren_default$3(match) {
	return this.selectAll(match == null ? children$3 : childrenFilter$3(typeof match === "function" ? match : childMatcher$3(match)));
}
//#endregion
//#region node_modules/d3-drag/node_modules/d3-selection/src/selection/filter.js
function filter_default$6(match) {
	if (typeof match !== "function") match = matcher_default$3(match);
...
function sparse_default$3(update) {
	return new Array(update.length);
}
//#endregion
//#region node_modules/d3-drag/node_modules/d3-selection/src/selection/enter.js
function enter_default$3() {
	return new Selection$6(this._enter || this._groups.map(sparse_default$3), this._parents);
}
...
function constant_default$14(x) {
	return function() {
		return x;
	};
}
...
function bindIndex$3(parent, group, enter, update, exit, data) {
	...
	for (; i < dataLength; ++i) if (node = group[i]) {
		...
		update[i] = node;
	} else enter[i] = new EnterNode$3(parent, data[i]);
...
function data_default$4(value, key) {
	...
	if (typeof value !== "function") value = constant_default$14(value);
	for (var m = groups.length, update = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
		var parent = parents[j], group = groups[j], groupLength = group.length, data = arraylike$3(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength);
...
function exit_default$3() {
	return new Selection$6(this._exit || this._groups.map(sparse_default$3), this._parents);
}
//#endregion
//#region node_modules/d3-drag/node_modules/d3-selection/src/selection/join.js
function join_default$3(onenter, onupdate, onexit) {
...
function merge_default$6(context) {
...
function sort_default$4(compare) {
...
function attr_default$6(name, value) {
	var fullname = namespace_default$3(name);
	if (arguments.length < 2) {
		var node = this.node();
...
function window_default$3(node) {
...
function style_default$6(name, value, priority) {
	return arguments.length > 1 ? this.each((value == null ? styleRemove$6 : typeof value === "function" ? styleFunction$6 : styleConstant$6)(name, value, priority == null ? "" : priority)) : styleValue$3(this.node(), name);
}
function styleValue$3(node, name) {
	return node.style.getPropertyValue(name) || window_default$3(node).getComputedStyle(node, null).getPropertyValue(name);
}
//#endregion
...
function property_default$3(name, value) {
...
function classed_default$3(name, value) {
...
function lower_default$3() {
	return this.each(lower$3);
}
//#endregion
//#region node_modules/d3-drag/node_modules/d3-selection/src/selection/append.js
function append_default$3(name) {
	var create = typeof name === "function" ? name : creator_default$3(name);
...
function insert_default$3(name, before) {
	var create = typeof name === "function" ? name : creator_default$3(name), select = before == null ? constantNull$3 : typeof before === "function" ? before : selector_default$3(before);
	return this.select(function() {
...
function datum_default$3(value) {
...
function on_default$6(typename, value, options) {
...
function dispatchEvent$3(node, type, params) {
	var window = window_default$3(node), event = window.CustomEvent;
...
function dispatch_default$3(type, params) {
...
function selection$3() {
	return new Selection$6([[document.documentElement]], root$4);
}
...
Selection$6.prototype = selection$3.prototype = {
	...
	select: select_default$10,
	selectAll: selectAll_default$7,
	selectChild: selectChild_default$3,
	selectChildren: selectChildren_default$3,
	filter: filter_default$6,
	data: data_default$4,
	enter: enter_default$3,
	exit: exit_default$3,
	join: join_default$3,
	merge: merge_default$6,
	selection: selection_selection$3,
	order: order_default$3,
	sort: sort_default$4,
	call: call_default$3,
	nodes: nodes_default$3,
	node: node_default$3,
	size: size_default$4,
	empty: empty_default$3,
	each: each_default$4,
	attr: attr_default$6,
	style: style_default$6,
	property: property_default$3,
	classed: classed_default$3,
	text: text_default$7,
	html: html_default$3,
	raise: raise_default$3,
	lower: lower_default$3,
	append: append_default$3,
	insert: insert_default$3,
	remove: remove_default$7,
	clone: clone_default$3,
	datum: datum_default$3,
	on: on_default$6,
	dispatch: dispatch_default$3,
	[Symbol.iterator]: iterator_default$4
};
//#endregion
//#region node_modules/d3-drag/node_modules/d3-selection/src/select.js
function select_default$9(selector) {
	return typeof selector === "string" ? new Selection$6([[document.querySelector(selector)]], [document.documentElement]) : new Selection$6([[selector]], root$4);
}
//#endregion
//#region node_modules/d3-drag/node_modules/d3-selection/src/sourceEvent.js
function sourceEvent_default$3(event) {
	let sourceEvent;
	while (sourceEvent = event.sourceEvent) event = sourceEvent;
	return event;
}
//#endregion
//#region node_modules/d3-drag/node_modules/d3-selection/src/pointer.js
function pointer_default$3(event, node) {
	event = sourceEvent_default$3(event);
...
function nodrag_default(view) {
	var root = view.document.documentElement, selection = select_default$9(view).on("dragstart.drag", noevent_default$2, nonpassivecapture);
...
function yesdrag(view, noclick) {
	var root = view.document.documentElement, selection = select_default$9(view).on("dragstart.drag", null);
	if (noclick) {
...
function drag_default() {
	...
	function mousedowned(event, d) {
		...
		if (!gesture) return;
		select_default$9(event.view).on("mousemove.drag", mousemoved, nonpassivecapture).on("mouseup.drag", mouseupped, nonpassivecapture);
	...
	function mouseupped(event) {
		select_default$9(event.view).on("mousemove.drag mouseup.drag", null);
	...
	function beforestart(that, container, event, d, identifier, touch) {
		var dispatch = listeners.copy(), p = pointer_default$3(touch || event, container), dx, dy, s;
		...
		return function gesture(type, event, touch) {
			...
			switch (type) {
				...
				case "drag":
					p = pointer_default$3(touch || event, container), n = active;
					break;
			}
	...
	drag.filter = function(_) {
		return arguments.length ? (filter = typeof _ === "function" ? _ : constant_default$13(!!_), drag) : filter;
	};
	drag.container = function(_) {
		return arguments.length ? (container = typeof _ === "function" ? _ : constant_default$13(_), drag) : container;
	};
	drag.subject = function(_) {
		return arguments.length ? (subject = typeof _ === "function" ? _ : constant_default$13(_), drag) : subject;
	};
	drag.touchable = function(_) {
		return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default$13(!!_), drag) : touchable;
	};
	drag.on = function() {
...
//#endregion
//#region node_modules/d3-interpolate/node_modules/d3-color/src/define.js
function define_default$1(constructor, factory, prototype) {
...
//#endregion
//#region node_modules/d3-interpolate/node_modules/d3-color/src/color.js
function Color$1() {}
var darker$1 = .7;
var brighter$1 = 1 / darker$1;
var reI$1 = "\\s*([+-]?\\d+)\\s*", reN$1 = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)\\s*", reP$1 = "\\s*([+-]?\\d*\\.?\\d+(?:[eE][+-]?\\d+)?)%\\s*", reHex$1 = /^#([0-9a-f]{3,8})$/, reRgbInteger$1 = new RegExp("^rgb\\(" + [
	reI$1,
	reI$1,
	reI$1
] + "\\)$"), reRgbPercent$1 = new RegExp("^rgb\\(" + [
	reP$1,
	reP$1,
	reP$1
] + "\\)$"), reRgbaInteger$1 = new RegExp("^rgba\\(" + [
	reI$1,
	reI$1,
	reI$1,
	reN$1
] + "\\)$"), reRgbaPercent$1 = new RegExp("^rgba\\(" + [
	reP$1,
	reP$1,
	reP$1,
	reN$1
] + "\\)$"), reHslPercent$1 = new RegExp("^hsl\\(" + [
	reN$1,
	reP$1,
	reP$1
] + "\\)$"), reHslaPercent$1 = new RegExp("^hsla\\(" + [
	reN$1,
	reP$1,
	reP$1,
	reN$1
...
define_default$1(Color$1, color$1, {
...
define_default$1(Rgb$1, rgb$1, extend$1(Color$1, {
	brighter: function(k) {
...
define_default$1(Hsl$1, hsl$2, extend$1(Color$1, {
	brighter: function(k) {
		k = k == null ? brighter$1 : Math.pow(brighter$1, k);
...
function constant_default$12(x) {
	return function() {
		return x;
	};
}
...
function gamma$1(y) {
	return (y = +y) === 1 ? nogamma$1 : function(a, b) {
		return b - a ? exponential$1(a, b, y) : constant_default$12(isNaN(a) ? b : a);
	};
}
function nogamma$1(a, b) {
	var d = b - a;
	return d ? linear$3(a, d) : constant_default$12(isNaN(a) ? b : a);
}
//#endregion
//#region node_modules/d3-interpolate/src/rgb.js
var rgb_default$1 = (function rgbGamma(y) {
	var color = gamma$1(y);
	function rgb(start, end) {
		var r = color((start = rgb$1(start)).r, (end = rgb$1(end)).r), g = color(start.g, end.g), b = color(start.b, end.b), opacity = nogamma$1(start.opacity, end.opacity);
		return function(t) {
			start.r = r(t);
			start.g = g(t);
			start.b = b(t);
...
function numberArray_default$1(a, b) {
	if (!b) b = [];
...
function genericArray$1(a, b) {
	...
	for (i = 0; i < na; ++i) x[i] = value_default$1(a[i], b[i]);
	for (; i < nb; ++i) c[i] = b[i];
	return function(t) {
...
function object_default$1(a, b) {
	var i = {}, c = {}, k;
	if (a === null || typeof a !== "object") a = {};
	if (b === null || typeof b !== "object") b = {};
	for (k in b) if (k in a) i[k] = value_default$1(a[k], b[k]);
	else c[k] = b[k];
	return function(t) {
...
function value_default$1(a, b) {
	var t = typeof b, c;
	return b == null || t === "boolean" ? constant_default$12(b) : (t === "number" ? number_default$1 : t === "string" ? (c = color$1(b)) ? (b = c, rgb_default$1) : string_default$1 : b instanceof color$1 ? rgb_default$1 : b instanceof Date ? date_default$1 : isNumberArray$1(b) ? numberArray_default$1 : Array.isArray(b) ? genericArray$1 : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default$1 : number_default$1)(a, b);
}
//#endregion
...
function decompose_default$1(a, b, c, d, e, f) {
...
var cssNode, cssRoot, cssView, svgNode$1;
function parseCss$1(value) {
	...
	return decompose_default$1(+value[0], +value[1], +value[2], +value[3], +value[4], +value[5]);
}
function parseSvg$1(value) {
	...
	value = value.matrix;
	return decompose_default$1(value.a, value.b, value.c, value.d, value.e, value.f);
}
//#endregion
...
function interpolateTransform$1(parse, pxComma, pxParen, degParen) {
	...
	function translate(xa, ya, xb, yb, s, q) {
		if (xa !== xb || ya !== yb) {
			...
			q.push({
				i: i - 4,
				x: number_default$1(xa, xb)
			}, {
				i: i - 2,
				x: number_default$1(ya, yb)
			});
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/namespace.js
function namespace_default$2(name) {
	var prefix = name += "", i = prefix.indexOf(":");
	if (i >= 0 && (prefix = name.slice(0, i)) !== "xmlns") name = name.slice(i + 1);
	return namespaces_default$2.hasOwnProperty(prefix) ? {
		space: namespaces_default$2[prefix],
		local: name
	} : name;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/creator.js
...
function creator_default$2(name) {
	var fullname = namespace_default$2(name);
	return (fullname.local ? creatorFixed$2 : creatorInherit$2)(fullname);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selector.js
function none$2() {}
function selector_default$2(selector) {
	return selector == null ? none$2 : function() {
		return this.querySelector(selector);
	};
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/select.js
function select_default$8(select) {
	if (typeof select !== "function") select = selector_default$2(select);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) if ((node = group[i]) && (subnode = select.call(node, node.__data__, i, group))) {
		if ("__data__" in node) subnode.__data__ = node.__data__;
		subgroup[i] = subnode;
	}
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/array.js
function array$3(x) {
	return x == null ? [] : Array.isArray(x) ? x : Array.from(x);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selectorAll.js
function empty$3() {
	return [];
}
function selectorAll_default$2(selector) {
	return selector == null ? empty$3 : function() {
		return this.querySelectorAll(selector);
	};
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/selectAll.js
function arrayAll$2(select) {
	return function() {
		return array$3(select.apply(this, arguments));
	};
}
function selectAll_default$6(select) {
	if (typeof select === "function") select = arrayAll$2(select);
	else select = selectorAll_default$2(select);
	for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) {
		subgroups.push(select.call(node, node.__data__, i, group));
		parents.push(node);
	}
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/matcher.js
function matcher_default$2(selector) {
	return function() {
		return this.matches(selector);
	};
}
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/selectChild.js
...
function selectChild_default$2(match) {
	return this.select(match == null ? childFirst$2 : childFind$2(typeof match === "function" ? match : childMatcher$2(match)));
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/selectChildren.js
...
function selectChildren_default$2(match) {
	return this.selectAll(match == null ? children$2 : childrenFilter$2(typeof match === "function" ? match : childMatcher$2(match)));
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/filter.js
function filter_default$5(match) {
	if (typeof match !== "function") match = matcher_default$2(match);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = [], node, i = 0; i < n; ++i) if ((node = group[i]) && match.call(node, node.__data__, i, group)) subgroup.push(node);
	return new Selection$5(subgroups, this._parents);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/sparse.js
function sparse_default$2(update) {
	return new Array(update.length);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/enter.js
function enter_default$2() {
	return new Selection$5(this._enter || this._groups.map(sparse_default$2), this._parents);
}
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/constant.js
function constant_default$11(x) {
	return function() {
		return x;
	};
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/data.js
function bindIndex$2(parent, group, enter, update, exit, data) {
	var i = 0, node, groupLength = group.length, dataLength = data.length;
	for (; i < dataLength; ++i) if (node = group[i]) {
		node.__data__ = data[i];
		update[i] = node;
	} else enter[i] = new EnterNode$2(parent, data[i]);
	for (; i < groupLength; ++i) if (node = group[i]) exit[i] = node;
}
...
function data_default$3(value, key) {
	...
	if (typeof value !== "function") value = constant_default$11(value);
	for (var m = groups.length, update = new Array(m), enter = new Array(m), exit = new Array(m), j = 0; j < m; ++j) {
		var parent = parents[j], group = groups[j], groupLength = group.length, data = arraylike$2(value.call(parent, parent && parent.__data__, j, parents)), dataLength = data.length, enterGroup = enter[j] = new Array(dataLength), updateGroup = update[j] = new Array(dataLength);
		bind(parent, group, enterGroup, updateGroup, exit[j] = new Array(groupLength), data, key);
		for (var i0 = 0, i1 = 0, previous, next; i0 < dataLength; ++i0) if (previous = enterGroup[i0]) {
			if (i0 >= i1) i1 = i0 + 1;
			while (!(next = updateGroup[i1]) && ++i1 < dataLength);
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/exit.js
function exit_default$2() {
	return new Selection$5(this._exit || this._groups.map(sparse_default$2), this._parents);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/join.js
function join_default$2(onenter, onupdate, onexit) {
	var enter = this.enter(), update = this, exit = this.exit();
	if (typeof onenter === "function") {
		enter = onenter(enter);
		if (enter) enter = enter.selection();
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/merge.js
function merge_default$5(context) {
	var selection = context.selection ? context.selection() : context;
	for (var groups0 = this._groups, groups1 = selection._groups, m0 = groups0.length, m1 = groups1.length, m = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m; ++j) for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge = merges[j] = new Array(n), node, i = 0; i < n; ++i) if (node = group0[i] || group1[i]) merge[i] = node;
	for (; j < m0; ++j) merges[j] = groups0[j];
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/order.js
function order_default$2() {
	for (var groups = this._groups, j = -1, m = groups.length; ++j < m;) for (var group = groups[j], i = group.length - 1, next = group[i], node; --i >= 0;) if (node = group[i]) {
		if (next && node.compareDocumentPosition(next) ^ 4) next.parentNode.insertBefore(node, next);
		next = node;
	}
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/sort.js
function sort_default$3(compare) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/call.js
function call_default$2() {
	var callback = arguments[0];
	arguments[0] = this;
	callback.apply(null, arguments);
	return this;
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/nodes.js
function nodes_default$2() {
	return Array.from(this);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/node.js
function node_default$2() {
	for (var groups = this._groups, j = 0, m = groups.length; j < m; ++j) for (var group = groups[j], i = 0, n = group.length; i < n; ++i) {
		var node = group[i];
		if (node) return node;
	}
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/size.js
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/empty.js
function empty_default$2() {
	return !this.node();
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/each.js
function each_default$3(callback) {
	for (var groups = this._groups, j = 0, m = groups.length; j < m; ++j) for (var group = groups[j], i = 0, n = group.length, node; i < n; ++i) if (node = group[i]) callback.call(node, node.__data__, i, group);
	return this;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/attr.js
...
function attr_default$5(name, value) {
	var fullname = namespace_default$2(name);
	if (arguments.length < 2) {
		var node = this.node();
		return fullname.local ? node.getAttributeNS(fullname.space, fullname.local) : node.getAttribute(fullname);
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/window.js
function window_default$2(node) {
	return node.ownerDocument && node.ownerDocument.defaultView || node.document && node || node.defaultView;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/style.js
...
function style_default$5(name, value, priority) {
...
function styleValue$2(node, name) {
	return node.style.getPropertyValue(name) || window_default$2(node).getComputedStyle(node, null).getPropertyValue(name);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/property.js
...
function property_default$2(name, value) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/classed.js
...
function classed_default$2(name, value) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/text.js
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/html.js
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/raise.js
function raise$2() {
	if (this.nextSibling) this.parentNode.appendChild(this);
}
function raise_default$2() {
	return this.each(raise$2);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/lower.js
function lower$2() {
	if (this.previousSibling) this.parentNode.insertBefore(this, this.parentNode.firstChild);
}
function lower_default$2() {
	return this.each(lower$2);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/append.js
function append_default$2(name) {
	var create = typeof name === "function" ? name : creator_default$2(name);
	return this.select(function() {
		return this.appendChild(create.apply(this, arguments));
	});
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/insert.js
function constantNull$2() {
	return null;
}
function insert_default$2(name, before) {
	var create = typeof name === "function" ? name : creator_default$2(name), select = before == null ? constantNull$2 : typeof before === "function" ? before : selector_default$2(before);
	return this.select(function() {
		return this.insertBefore(create.apply(this, arguments), select.apply(this, arguments) || null);
	});
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/remove.js
function remove$2() {
	var parent = this.parentNode;
	if (parent) parent.removeChild(this);
}
function remove_default$6() {
	return this.each(remove$2);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/clone.js
...
function clone_default$2(deep) {
	return this.select(deep ? selection_cloneDeep$2 : selection_cloneShallow$2);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/datum.js
function datum_default$2(value) {
	return arguments.length ? this.property("__data__", value) : this.node().__data__;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/on.js
...
function on_default$5(typename, value, options) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/dispatch.js
function dispatchEvent$2(node, type, params) {
	var window = window_default$2(node), event = window.CustomEvent;
	if (typeof event === "function") event = new event(type, params);
	else {
		event = window.document.createEvent("Event");
		if (params) event.initEvent(type, params.bubbles, params.cancelable), event.detail = params.detail;
...
function dispatch_default$2(type, params) {
	return this.each((typeof params === "function" ? dispatchFunction$2 : dispatchConstant$2)(type, params));
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/iterator.js
function* iterator_default$3() {
	for (var groups = this._groups, j = 0, m = groups.length; j < m; ++j) for (var group = groups[j], i = 0, n = group.length, node; i < n; ++i) if (node = group[i]) yield node;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/selection/index.js
var root$3 = [null];
...
Selection$5.prototype = selection$2.prototype = {
	...
	select: select_default$8,
	selectAll: selectAll_default$6,
	selectChild: selectChild_default$2,
	selectChildren: selectChildren_default$2,
	filter: filter_default$5,
	data: data_default$3,
	enter: enter_default$2,
	exit: exit_default$2,
	join: join_default$2,
	merge: merge_default$5,
	selection: selection_selection$2,
	order: order_default$2,
	sort: sort_default$3,
	call: call_default$2,
	nodes: nodes_default$2,
	node: node_default$2,
	size: size_default$3,
	empty: empty_default$2,
	each: each_default$3,
	attr: attr_default$5,
	style: style_default$5,
	property: property_default$2,
	classed: classed_default$2,
	text: text_default$6,
	html: html_default$2,
	raise: raise_default$2,
	lower: lower_default$2,
	append: append_default$2,
	insert: insert_default$2,
	remove: remove_default$6,
	clone: clone_default$2,
	datum: datum_default$2,
	on: on_default$5,
	dispatch: dispatch_default$2,
	[Symbol.iterator]: iterator_default$3
};
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/select.js
function select_default$7(selector) {
	return typeof selector === "string" ? new Selection$5([[document.querySelector(selector)]], [document.documentElement]) : new Selection$5([[selector]], root$3);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/sourceEvent.js
function sourceEvent_default$2(event) {
	let sourceEvent;
	while (sourceEvent = event.sourceEvent) event = sourceEvent;
	return event;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-selection/src/pointer.js
function pointer_default$2(event, node) {
	event = sourceEvent_default$2(event);
	if (node === void 0) node = event.currentTarget;
	if (node) {
		var svg = node.ownerSVGElement || node;
		if (svg.createSVGPoint) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/schedule.js
var emptyOn$2 = dispatch("start", "end", "cancel", "interrupt");
var emptyTween$2 = [];
function schedule_default$2(node, name, id, index, group, timing) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/interrupt.js
function interrupt_default$5(node, name) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/selection/interrupt.js
function interrupt_default$4(name) {
	return this.each(function() {
		interrupt_default$5(this, name);
	});
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/tween.js
...
function tween_default$2(name, value) {
	var id = this._id;
	name += "";
	if (arguments.length < 2) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/interpolate.js
function interpolate_default$3(a, b) {
	var c;
	return (typeof b === "number" ? number_default$1 : b instanceof color ? rgb_default$1 : (c = color(b)) ? (b = c, rgb_default$1) : string_default$1)(a, b);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/attr.js
...
function attr_default$4(name, value) {
	var fullname = namespace_default$2(name), i = fullname === "transform" ? interpolateTransformSvg$1 : interpolate_default$3;
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/attrTween.js
...
function attrTween_default$2(name, value) {
	var key = "attr." + name;
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/delay.js
...
function delay_default$2(value) {
	var id = this._id;
	return arguments.length ? this.each((typeof value === "function" ? delayFunction$2 : delayConstant$2)(id, value)) : get$2(this.node(), id).delay;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/duration.js
...
function duration_default$2(value) {
	var id = this._id;
	return arguments.length ? this.each((typeof value === "function" ? durationFunction$2 : durationConstant$2)(id, value)) : get$2(this.node(), id).duration;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/ease.js
...
function ease_default$2(value) {
	var id = this._id;
	return arguments.length ? this.each(easeConstant$2(id, value)) : get$2(this.node(), id).ease;
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/easeVarying.js
...
function easeVarying_default$2(value) {
	if (typeof value !== "function") throw new Error();
	return this.each(easeVarying$2(this._id, value));
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/filter.js
function filter_default$4(match) {
	if (typeof match !== "function") match = matcher_default$2(match);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = [], node, i = 0; i < n; ++i) if ((node = group[i]) && match.call(node, node.__data__, i, group)) subgroup.push(node);
	return new Transition$2(subgroups, this._parents, this._name, this._id);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/merge.js
function merge_default$4(transition) {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/on.js
...
function onFunction$2(id, name, listener) {
	var on0, on1, sit = start$2(name) ? init$2 : set$2;
	return function() {
...
function on_default$4(name, listener) {
	var id = this._id;
	return arguments.length < 2 ? get$2(this.node(), id).on.on(name) : this.each(onFunction$2(id, name, listener));
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/remove.js
...
function remove_default$5() {
	return this.on("end.remove", removeFunction$2(this._id));
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/select.js
function select_default$6(select) {
	var name = this._name, id = this._id;
	if (typeof select !== "function") select = selector_default$2(select);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) if ((node = group[i]) && (subnode = select.call(node, node.__data__, i, group))) {
		if ("__data__" in node) subnode.__data__ = node.__data__;
		subgroup[i] = subnode;
		schedule_default$2(subgroup[i], name, id, i, subgroup, get$2(node, id));
	}
	return new Transition$2(subgroups, this._parents, name, id);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/selectAll.js
function selectAll_default$5(select) {
	var name = this._name, id = this._id;
	if (typeof select !== "function") select = selectorAll_default$2(select);
	for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) {
		for (var children = select.call(node, node.__data__, i, group), child, inherit = get$2(node, id), k = 0, l = children.length; k < l; ++k) if (child = children[k]) schedule_default$2(child, name, id, k, children, inherit);
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/selection.js
var Selection$4 = selection$2.prototype.constructor;
function selection_default$2() {
	return new Selection$4(this._groups, this._parents);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/style.js
...
function styleMaybeRemove$2(id, name) {
	...
	return function() {
		var schedule = set$2(this, id), on = schedule.on, listener = schedule.value[key] == null ? remove || (remove = styleRemove$4(name)) : void 0;
		if (on !== on0 || listener0 !== listener) (on1 = (on0 = on).copy()).on(event, listener0 = listener);
		schedule.on = on1;
	};
}
function style_default$4(name, value, priority) {
	var i = (name += "") === "transform" ? interpolateTransformCss$1 : interpolate_default$3;
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/styleTween.js
...
function styleTween_default$2(name, value, priority) {
	var key = "style." + (name += "");
	if (arguments.length < 2) return (key = this.tween(key)) && key._value;
	if (value == null) return this.tween(key, null);
	if (typeof value !== "function") throw new Error();
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/text.js
...
function textTween_default$2(value) {
	var key = "text";
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/transition.js
function transition_default$5() {
	...
	for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) {
		...
		schedule_default$2(node, name, id1, i, group, {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/end.js
function end_default$2() {
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/transition/index.js
var id$2 = 0;
...
Transition$2.prototype = transition$2.prototype = {
	...
	select: select_default$6,
	selectAll: selectAll_default$5,
	selectChild: selection_prototype$2.selectChild,
	selectChildren: selection_prototype$2.selectChildren,
	filter: filter_default$4,
	merge: merge_default$4,
	selection: selection_default$2,
	transition: transition_default$5,
	...
	on: on_default$4,
	attr: attr_default$4,
	attrTween: attrTween_default$2,
	style: style_default$4,
	styleTween: styleTween_default$2,
	text: text_default$5,
	textTween: textTween_default$2,
	remove: remove_default$5,
	tween: tween_default$2,
	delay: delay_default$2,
	duration: duration_default$2,
	ease: ease_default$2,
	easeVarying: easeVarying_default$2,
	end: end_default$2,
...
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/selection/transition.js
var defaultTiming$2 = {
	time: null,
	delay: 0,
	duration: 250,
...
function transition_default$4(name) {
	var id, timing;
	if (name instanceof Transition$2) id = name._id, name = name._name;
	else id = newId$2(), (timing = defaultTiming$2).time = now(), name = name == null ? null : name + "";
	for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) schedule_default$2(node, name, id, i, group, timing || inherit$2(node, id));
	return new Transition$2(groups, this._parents, name, id);
}
//#endregion
//#region node_modules/d3-brush/node_modules/d3-transition/src/selection/index.js
selection$2.prototype.interrupt = interrupt_default$4;
selection$2.prototype.transition = transition_default$4;
//#endregion
//#region node_modules/d3-brush/src/constant.js
var constant_default$10 = (x) => () => x;
//#endregion
...
var { abs: abs$3, max: max$4, min: min$2 } = Math;
function number1(e) {
	return [+e[0], +e[1]];
}
function number2(e) {
...
function brush(dim) {
	...
	function brush(group) {
		...
		overlay.enter().append("rect").attr("class", "overlay").attr("pointer-events", "all").attr("cursor", cursors.overlay).merge(overlay).each(function() {
			...
			select_default$7(this).attr("x", extent[0][0]).attr("y", extent[0][1]).attr("width", extent[1][0] - extent[0][0]).attr("height", extent[1][1] - extent[0][1]);
		});
	...
	brush.move = function(group, selection, event) {
		if (group.tween) group.on("start.brush", function(event) {
			...
			var that = this, state = that.__brush, emit = emitter(that, arguments), selection0 = state.selection, selection1 = dim.input(typeof selection === "function" ? selection.apply(this, arguments) : selection, state.extent), i = value_default$1(selection0, selection1);
			function tween(t) {
	...
	function redraw() {
		var group = select_default$7(this), selection = local$1(this).selection;
		if (selection) {
	...
	Emitter.prototype = {
		...
		emit: function(type, event, mode) {
			var d = select_default$7(this.that).datum();
	...
	function started(event) {
		...
		if (type === "overlay") {
			...
			state.selection = selection = [[w0 = dim === Y ? W : min$2(pts[0][0], pts[1][0]), n0 = dim === X ? N : min$2(pts[0][1], pts[1][1])], [e0 = dim === Y ? E : max$4(pts[0][0], pts[1][0]), s0 = dim === X ? S : max$4(pts[0][1], pts[1][1])]];
		...
		e1 = e0;
		s1 = s0;
		var group = select_default$7(that).attr("pointer-events", "none");
		var overlay = group.selectAll(".overlay").attr("cursor", cursors[type]);
		if (event.touches) {
			emit.moved = moved;
			emit.ended = ended;
		} else {
			var view = select_default$7(event.view).on("mousemove.brush", moved, true).on("mouseup.brush", ended, true);
		...
		function moved(event) {
			for (const p of event.changedTouches || [event]) for (const d of points) if (d.identifier === p.identifier) d.cur = pointer_default$2(p, that);
	...
	brush.extent = function(_) {
		return arguments.length ? (extent = typeof _ === "function" ? _ : constant_default$10(number2(_)), brush) : extent;
	};
	brush.filter = function(_) {
		return arguments.length ? (filter = typeof _ === "function" ? _ : constant_default$10(!!_), brush) : filter;
	};
	brush.touchable = function(_) {
		return arguments.length ? (touchable = typeof _ === "function" ? _ : constant_default$10(!!_), brush) : touchable;
	};
...
function ribbon(headRadius) {
	...
	if (headRadius) ribbon.headRadius = function(_) {
		return arguments.length ? (headRadius = typeof _ === "function" ? _ : constant_default$9(+_), ribbon) : headRadius;
	};
	ribbon.radius = function(_) {
		return arguments.length ? (sourceRadius = targetRadius = typeof _ === "function" ? _ : constant_default$9(+_), ribbon) : sourceRadius;
	};
	ribbon.sourceRadius = function(_) {
		return arguments.length ? (sourceRadius = typeof _ === "function" ? _ : constant_default$9(+_), ribbon) : sourceRadius;
	};
	ribbon.targetRadius = function(_) {
		return arguments.length ? (targetRadius = typeof _ === "function" ? _ : constant_default$9(+_), ribbon) : targetRadius;
	};
	ribbon.startAngle = function(_) {
		return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default$9(+_), ribbon) : startAngle;
	};
	ribbon.endAngle = function(_) {
		return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default$9(+_), ribbon) : endAngle;
	};
	ribbon.padAngle = function(_) {
		return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default$9(+_), ribbon) : padAngle;
	};
...
//#endregion
//#region node_modules/d3-contour/node_modules/d3-array/src/blur.js
var blur2$1 = Blur2(blurf);
function Blur2(blur) {
	return function(data, rx, ry = rx) {
		if (!((rx = +rx) >= 0)) throw new RangeError("invalid rx");
		if (!((ry = +ry) >= 0)) throw new RangeError("invalid ry");
...
//#endregion
//#region node_modules/d3-contour/node_modules/d3-array/src/count.js
...
//#endregion
//#region node_modules/d3-contour/node_modules/d3-array/src/extent.js
...
//#endregion
//#region node_modules/d3-contour/node_modules/d3-array/src/ticks.js
var e10$1 = Math.sqrt(50), e5$1 = Math.sqrt(10), e2$1 = Math.sqrt(2);
function tickSpec(start, stop, count) {
	const step = (stop - start) / Math.max(0, count), power = Math.floor(Math.log10(step)), error = step / Math.pow(10, power), factor = error >= e10$1 ? 10 : error >= e5$1 ? 5 : error >= e2$1 ? 2 : 1;
	let i1, i2, inc;
	if (power < 0) {
		inc = Math.pow(10, -power) / factor;
		i1 = Math.round(start * inc);
...
//#endregion
//#region node_modules/d3-contour/node_modules/d3-array/src/nice.js
...
//#endregion
//#region node_modules/d3-contour/node_modules/d3-array/src/threshold/sturges.js
function thresholdSturges$1(values) {
	return Math.max(1, Math.ceil(Math.log(count$2(values)) / Math.LN2) + 1);
}
//#endregion
//#region node_modules/d3-contour/node_modules/d3-array/src/max.js
...
function ascending_default$2(a, b) {
	return a - b;
}
//#endregion
...
function contours_default() {
	var dx = 1, dy = 1, threshold = thresholdSturges$1, smooth = smoothLinear;
	function contours(values) {
		...
		} else tz = tz.slice().sort(ascending_default$2);
	...
	contours.thresholds = function(_) {
		return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default$8(slice$1.call(_)) : constant_default$8(_), contours) : threshold;
	};
...
function density_default() {
	var x = defaultX$1, y = defaultY$1, weight = defaultWeight, dx = 960, dy = 500, r = 20, k = 2, o = r * 3, n = dx + o * 2 >> k, m = dy + o * 2 >> k, threshold = constant_default$8(20);
	function grid(data) {
	...
	function density(data) {
		...
		if (!Array.isArray(tz)) tz = ticks$1(Number.MIN_VALUE, max$2(values) / pow4k, tz);
	...
	density.x = function(_) {
		return arguments.length ? (x = typeof _ === "function" ? _ : constant_default$8(+_), density) : x;
	};
	density.y = function(_) {
		return arguments.length ? (y = typeof _ === "function" ? _ : constant_default$8(+_), density) : y;
	};
	density.weight = function(_) {
		return arguments.length ? (weight = typeof _ === "function" ? _ : constant_default$8(+_), density) : weight;
	};
	...
	density.thresholds = function(_) {
		return arguments.length ? (threshold = typeof _ === "function" ? _ : Array.isArray(_) ? constant_default$8(slice$1.call(_)) : constant_default$8(_), density) : threshold;
	};
...
//#endregion
//#region node_modules/d3/node_modules/d3-fetch/src/blob.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-fetch/src/buffer.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-fetch/src/text.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-fetch/src/dsv.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-fetch/src/image.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-fetch/src/json.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-fetch/src/xml.js
...
treeProto.data = data_default$2;
treeProto.extent = extent_default$1;
treeProto.find = find_default$1;
treeProto.remove = remove_default$4;
treeProto.removeAll = removeAll;
treeProto.root = root_default;
treeProto.size = size_default$2;
...
function collide_default(radius) {
	...
	if (typeof radius !== "function") radius = constant_default$7(radius == null ? 1 : +radius);
	function force() {
	...
	force.radius = function(_) {
		return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default$7(+_), initialize(), force) : radius;
	};
	return force;
}
//#endregion
...
function link_default(links) {
	var id = index$1, strength = defaultStrength, strengths, distance = constant_default$7(30), distances, nodes, count, bias, random, iterations = 1;
	if (links == null) links = [];
	...
	force.strength = function(_) {
		return arguments.length ? (strength = typeof _ === "function" ? _ : constant_default$7(+_), initializeStrength(), force) : strength;
	};
	force.distance = function(_) {
		return arguments.length ? (distance = typeof _ === "function" ? _ : constant_default$7(+_), initializeDistance(), force) : distance;
	};
	return force;
}
//#endregion
...
function manyBody_default() {
	var nodes, node, random, alpha, strength = constant_default$7(-30), strengths, distanceMin2 = 1, distanceMax2 = Infinity, theta2 = .81;
	function force(_) {
	...
	force.strength = function(_) {
		return arguments.length ? (strength = typeof _ === "function" ? _ : constant_default$7(+_), initialize(), force) : strength;
	};
...
function radial_default(radius, x, y) {
	var nodes, strength = constant_default$7(.1), strengths, radiuses;
	if (typeof radius !== "function") radius = constant_default$7(+radius);
	if (x == null) x = 0;
	if (y == null) y = 0;
	function force(alpha) {
...
function x_default(x) {
	var strength = constant_default$7(.1), nodes, strengths, xz;
	if (typeof x !== "function") x = constant_default$7(x == null ? 0 : +x);
	function force(alpha) {
	...
	force.x = function(_) {
		return arguments.length ? (x = typeof _ === "function" ? _ : constant_default$7(+_), initialize(), force) : x;
	};
	return force;
}
//#endregion
...
function y_default(y) {
	var strength = constant_default$7(.1), nodes, strengths, yz;
	if (typeof y !== "function") y = constant_default$7(y == null ? 0 : +y);
	function force(alpha) {
	...
	force.y = function(_) {
		return arguments.length ? (y = typeof _ === "function" ? _ : constant_default$7(+_), initialize(), force) : y;
	};
	return force;
}
//#endregion
...
function ascendingComparator(f) {
	return (d, x) => ascending_default$1(f(d), x);
}
//#endregion
...
var areaSum$1 = new Adder$1(), lambda00$2, phi00$2, lambda0$2, cosPhi0$1, sinPhi0$1;
var areaStream$1 = {
	point: noop,
	lineStart: noop,
	lineEnd: noop,
...
function linePoint(lambda, phi) {
	...
	if (p0) {
		...
		var delta = lambda - lambda2, sign = delta > 0 ? 1 : -1, lambdai = inflection[0] * degrees$1 * sign, phii, antimeridian = abs$1(delta) > 180;
...
function circle_default() {
	var center = constant_default$6([0, 0]), radius = constant_default$6(90), precision = constant_default$6(2), ring, rotate, stream = { point };
	function point(x, y) {
	...
	circle.center = function(_) {
		return arguments.length ? (center = typeof _ === "function" ? _ : constant_default$6([+_[0], +_[1]]), circle) : center;
	};
	circle.radius = function(_) {
		return arguments.length ? (radius = typeof _ === "function" ? _ : constant_default$6(+_), circle) : radius;
	};
	circle.precision = function(_) {
		return arguments.length ? (precision = typeof _ === "function" ? _ : constant_default$6(+_), circle) : precision;
	};
	return circle;
}
//#endregion
...
function clipRectangle(x0, y0, x1, y1) {
	...
	return function(stream) {
		...
		function polygonEnd() {
			var startInside = polygonInside(), cleanInside = clean && startInside, visible = (segments = merge$1(segments)).length;
...
function graticuleX(y0, y1, dy) {
	var y = range_default(y0, y1 - epsilon$1, dy).concat(y1);
	return function(x) {
...
function graticuleY(x0, x1, dx) {
	var x = range_default(x0, x1 - epsilon$1, dx).concat(x1);
	return function(y) {
...
var areaSum = new Adder$1(), areaRingSum = new Adder$1(), x00$2, y00$2, x0$3, y0$3;
var areaStream = {
	point: noop,
	lineStart: noop,
	lineEnd: noop,
...
var lengthSum = new Adder$1(), lengthRing, x00, y00, x0, y0;
var lengthStream = {
	point: noop,
	lineStart: function() {
...
function projectionMutator(projectAt) {
	...
	projection.clipAngle = function(_) {
		return arguments.length ? (preclip = +_ ? circle_default$1(theta = _ * radians) : (theta = null, antimeridian_default), reset()) : theta * degrees$1;
	};
...
function each_default$2(callback, that) {
	let index = -1;
...
function sort_default$2(compare) {
...
Node.prototype = hierarchy.prototype = {
	...
	links: links_default,
	copy: node_copy,
	[Symbol.iterator]: iterator_default$2
};
//#endregion
...
function pack_default() {
	...
	pack.padding = function(x) {
		return arguments.length ? (padding = typeof x === "function" ? x : constant_default$5(+x), pack) : padding;
	};
	return pack;
}
...
function treemap_default() {
	...
	treemap.paddingInner = function(x) {
		return arguments.length ? (paddingInner = typeof x === "function" ? x : constant_default$5(+x), treemap) : paddingInner;
	};
	treemap.paddingOuter = function(x) {
		return arguments.length ? treemap.paddingTop(x).paddingRight(x).paddingBottom(x).paddingLeft(x) : treemap.paddingTop();
	};
	treemap.paddingTop = function(x) {
		return arguments.length ? (paddingTop = typeof x === "function" ? x : constant_default$5(+x), treemap) : paddingTop;
	};
	treemap.paddingRight = function(x) {
		return arguments.length ? (paddingRight = typeof x === "function" ? x : constant_default$5(+x), treemap) : paddingRight;
	};
	treemap.paddingBottom = function(x) {
		return arguments.length ? (paddingBottom = typeof x === "function" ? x : constant_default$5(+x), treemap) : paddingBottom;
	};
	treemap.paddingLeft = function(x) {
		return arguments.length ? (paddingLeft = typeof x === "function" ? x : constant_default$5(+x), treemap) : paddingLeft;
	};
	return treemap;
}
//#endregion
...
function hue(a, b) {
	var d = b - a;
	return d ? linear$2(a, d > 180 || d < -180 ? d - 360 * Math.round(d / 360) : d) : constant_default$4(isNaN(a) ? b : a);
}
function gamma(y) {
	return (y = +y) === 1 ? nogamma : function(a, b) {
		return b - a ? exponential(a, b, y) : constant_default$4(isNaN(a) ? b : a);
	};
}
function nogamma(a, b) {
	var d = b - a;
	return d ? linear$2(a, d) : constant_default$4(isNaN(a) ? b : a);
}
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/rgb.js
var rgb_default = (function rgbGamma(y) {
	var color = gamma(y);
	function rgb$2(start, end) {
...
function value_default(a, b) {
	var t = typeof b, c;
	return b == null || t === "boolean" ? constant_default$4(b) : (t === "number" ? number_default : t === "string" ? (c = color(b)) ? (b = c, rgb_default) : string_default : b instanceof color ? rgb_default : b instanceof Date ? date_default : isNumberArray(b) ? numberArray_default : Array.isArray(b) ? genericArray : typeof b.valueOf !== "function" && typeof b.toString !== "function" || isNaN(b) ? object_default : number_default)(a, b);
}
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/discrete.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/hue.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/zoom.js
var epsilon2 = 1e-12;
function cosh(x) {
	return ((x = Math.exp(x)) + 1 / x) / 2;
}
...
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/hsl.js
function hsl$1(hue) {
...
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/lab.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/cubehelix.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/piecewise.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-interpolate/src/quantize.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/identity.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/log.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/symlog.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/pow.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/radial.js
function square(x) {
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/quantile.js
function quantile$1() {
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/quantize.js
function quantize() {
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/threshold.js
function threshold() {
...
function ticker(year, month, week, day, hour, minute) {
	...
	function tickInterval(start, stop, count) {
		...
		const i = bisector_default(([, , step]) => step).right(tickIntervals, target);
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/utcTime.js
function utcTime() {
	return initRange.apply(calendar(utcTicks, utcTickInterval, utcYear, utcMonth, utcSunday, utcDay, utcHour, utcMinute, second, utcFormat).domain([Date.UTC(2e3, 0, 1), Date.UTC(2e3, 0, 2)]), arguments);
}
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/sequential.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/sequentialQuantile.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale/src/diverging.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/category10.js
var category10_default = colors_default("1f77b4ff7f0e2ca02cd627289467bd8c564be377c27f7f7fbcbd2217becf");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Accent.js
var Accent_default = colors_default("7fc97fbeaed4fdc086ffff99386cb0f0027fbf5b17666666");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Dark2.js
var Dark2_default = colors_default("1b9e77d95f027570b3e7298a66a61ee6ab02a6761d666666");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/observable10.js
var observable10_default = colors_default("4269d0efb118ff725c6cc5b03ca951ff8ab7a463f297bbf59c6b4e9498a0");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Paired.js
var Paired_default = colors_default("a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Pastel1.js
var Pastel1_default = colors_default("fbb4aeb3cde3ccebc5decbe4fed9a6ffffcce5d8bdfddaecf2f2f2");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Pastel2.js
var Pastel2_default = colors_default("b3e2cdfdcdaccbd5e8f4cae4e6f5c9fff2aef1e2cccccccc");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Set1.js
var Set1_default = colors_default("e41a1c377eb84daf4a984ea3ff7f00ffff33a65628f781bf999999");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Set2.js
var Set2_default = colors_default("66c2a5fc8d628da0cbe78ac3a6d854ffd92fe5c494b3b3b3");
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/categorical/Set3.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/ramp.js
var ramp_default = (scheme) => rgbBasis(scheme[scheme.length - 1]);
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/BrBG.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/PRGn.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/PiYG.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/PuOr.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/RdBu.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/RdGy.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/RdYlBu.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/RdYlGn.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/diverging/Spectral.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/BuGn.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/BuPu.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/GnBu.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/OrRd.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/PuBuGn.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/PuBu.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/PuRd.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/RdPu.js
var scheme$18 = new Array(3).concat("fde0ddfa9fb5c51b8a", "feebe2fbb4b9f768a1ae017e", "feebe2fbb4b9f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1c51b8a7a0177", "feebe2fcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a0177", "fff7f3fde0ddfcc5c0fa9fb5f768a1dd3497ae017e7a017749006a").map(colors_default);
var RdPu_default = ramp_default(scheme$18);
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/YlGnBu.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/YlGn.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/YlOrBr.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/YlOrRd.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-single/Blues.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-single/Greens.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-single/Greys.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-single/Purples.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-single/Reds.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-single/Oranges.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/cividis.js
function cividis_default(t) {
	t = Math.max(0, Math.min(1, t));
	return "rgb(" + Math.max(0, Math.min(255, Math.round(-4.54 - t * (35.34 - t * (2381.73 - t * (6402.7 - t * (7024.72 - t * 2710.57))))))) + ", " + Math.max(0, Math.min(255, Math.round(32.49 + t * (170.73 + t * (52.82 - t * (131.46 - t * (176.58 - t * 67.37))))))) + ", " + Math.max(0, Math.min(255, Math.round(81.24 + t * (442.36 - t * (2482.43 - t * (6167.24 - t * (6614.94 - t * 2475.67))))))) + ")";
}
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/cubehelix.js
var cubehelix_default$1 = cubehelixLong(cubehelix(300, .5, 0), cubehelix(-240, .5, 1));
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/rainbow.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/sinebow.js
...
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/turbo.js
function turbo_default(t) {
	t = Math.max(0, Math.min(1, t));
	return "rgb(" + Math.max(0, Math.min(255, Math.round(34.61 + t * (1172.33 - t * (10793.56 - t * (33300.12 - t * (38394.49 - t * 14825.05))))))) + ", " + Math.max(0, Math.min(255, Math.round(23.31 + t * (557.33 + t * (1225.33 - t * (3574.96 - t * (1073.77 + t * 707.56))))))) + ", " + Math.max(0, Math.min(255, Math.round(27.2 + t * (3211.1 - t * (15327.97 - t * (27814 - t * (22569.18 - t * 6838.66))))))) + ")";
}
//#endregion
//#region node_modules/d3/node_modules/d3-scale-chromatic/src/sequential-multi/viridis.js
function ramp(range) {
	var n = range.length;
	return function(t) {
		return range[Math.max(0, Math.min(n - 1, Math.floor(t * n)))];
...
function select_default$5(select) {
...
function selectAll_default$4(select) {
...
function selectChild_default$1(match) {
...
function selectChildren_default$1(match) {
...
function filter_default$3(match) {
...
function sparse_default$1(update) {
	return new Array(update.length);
}
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/selection/enter.js
function enter_default$1() {
	return new Selection$3(this._enter || this._groups.map(sparse_default$1), this._parents);
}
...
function exit_default$1() {
	return new Selection$3(this._exit || this._groups.map(sparse_default$1), this._parents);
}
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/selection/join.js
function join_default$1(onenter, onupdate, onexit) {
	var enter = this.enter(), update = this, exit = this.exit();
	if (typeof onenter === "function") {
		enter = onenter(enter);
		if (enter) enter = enter.selection();
...
function merge_default$3(context) {
	var selection = context.selection ? context.selection() : context;
	for (var groups0 = this._groups, groups1 = selection._groups, m0 = groups0.length, m1 = groups1.length, m = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m; ++j) for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge = merges[j] = new Array(n), node, i = 0; i < n; ++i) if (node = group0[i] || group1[i]) merge[i] = node;
	for (; j < m0; ++j) merges[j] = groups0[j];
...
function attr_default$3(name, value) {
	var fullname = namespace_default(name);
	if (arguments.length < 2) {
		var node = this.node();
		return fullname.local ? node.getAttributeNS(fullname.space, fullname.local) : node.getAttribute(fullname);
...
function style_default$3(name, value, priority) {
	return arguments.length > 1 ? this.each((value == null ? styleRemove$3 : typeof value === "function" ? styleFunction$3 : styleConstant$3)(name, value, priority == null ? "" : priority)) : styleValue(this.node(), name);
}
...
function property_default$1(name, value) {
...
function classed_default$1(name, value) {
...
function insert_default$1(name, before) {
	var create = typeof name === "function" ? name : creator_default(name), select = before == null ? constantNull$1 : typeof before === "function" ? before : selector_default(before);
	return this.select(function() {
		return this.insertBefore(create.apply(this, arguments), select.apply(this, arguments) || null);
	});
}
...
function datum_default$1(value) {
	return arguments.length ? this.property("__data__", value) : this.node().__data__;
}
//#endregion
...
function on_default$3(typename, value, options) {
...
Selection$3.prototype = selection.prototype = {
	...
	select: select_default$5,
	selectAll: selectAll_default$4,
	selectChild: selectChild_default$1,
	selectChildren: selectChildren_default$1,
	filter: filter_default$3,
	data: data_default$1,
	enter: enter_default$1,
	exit: exit_default$1,
	join: join_default$1,
	merge: merge_default$3,
	selection: selection_selection$1,
	order: order_default$1,
	sort: sort_default$1,
	call: call_default$1,
	nodes: nodes_default$1,
	node: node_default$1,
	size: size_default$1,
	empty: empty_default$1,
	each: each_default$1,
	attr: attr_default$3,
	style: style_default$3,
	property: property_default$1,
	classed: classed_default$1,
	text: text_default$4,
	html: html_default$1,
	raise: raise_default$1,
	lower: lower_default$1,
	append: append_default$1,
	insert: insert_default$1,
	remove: remove_default$3,
	clone: clone_default$1,
	datum: datum_default$1,
	on: on_default$3,
...
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/create.js
function create_default(name) {
	return select_default(creator_default(name).call(document.documentElement));
}
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/local.js
var nextId = 0;
function local() {
	return new Local();
}
...
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/sourceEvent.js
function sourceEvent_default$1(event) {
	let sourceEvent;
	while (sourceEvent = event.sourceEvent) event = sourceEvent;
	return event;
}
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/pointer.js
function pointer_default(event, node) {
	event = sourceEvent_default$1(event);
	if (node === void 0) node = event.currentTarget;
	if (node) {
		var svg = node.ownerSVGElement || node;
		if (svg.createSVGPoint) {
...
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/pointers.js
function pointers_default(events, node) {
	if (events.target) {
		events = sourceEvent_default$1(events);
...
//#endregion
//#region node_modules/d3/node_modules/d3-selection/src/selectAll.js
function selectAll_default(selector) {
	return typeof selector === "string" ? new Selection$3([document.querySelectorAll(selector)], [document.documentElement]) : new Selection$3([array$1(selector)], root$2);
}
//#endregion
...
function arc_default() {
	var innerRadius = arcInnerRadius, outerRadius = arcOuterRadius, cornerRadius = constant_default$2(0), padRadius = null, startAngle = arcStartAngle, endAngle = arcEndAngle, padAngle = arcPadAngle, context = null, path = withPath(arc);
	function arc() {
	...
	arc.innerRadius = function(_) {
		return arguments.length ? (innerRadius = typeof _ === "function" ? _ : constant_default$2(+_), arc) : innerRadius;
	};
	arc.outerRadius = function(_) {
		return arguments.length ? (outerRadius = typeof _ === "function" ? _ : constant_default$2(+_), arc) : outerRadius;
	};
	arc.cornerRadius = function(_) {
		return arguments.length ? (cornerRadius = typeof _ === "function" ? _ : constant_default$2(+_), arc) : cornerRadius;
	};
	arc.padRadius = function(_) {
		return arguments.length ? (padRadius = _ == null ? null : typeof _ === "function" ? _ : constant_default$2(+_), arc) : padRadius;
	};
	arc.startAngle = function(_) {
		return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default$2(+_), arc) : startAngle;
	};
	arc.endAngle = function(_) {
		return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default$2(+_), arc) : endAngle;
	};
	arc.padAngle = function(_) {
		return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default$2(+_), arc) : padAngle;
	};
...
function line_default(x$4, y$4) {
	var defined = constant_default$2(true), context = null, curve = linear_default, output = null, path = withPath(line);
	x$4 = typeof x$4 === "function" ? x$4 : x$4 === void 0 ? x : constant_default$2(x$4);
	y$4 = typeof y$4 === "function" ? y$4 : y$4 === void 0 ? y : constant_default$2(y$4);
	function line(data) {
	...
	line.x = function(_) {
		return arguments.length ? (x$4 = typeof _ === "function" ? _ : constant_default$2(+_), line) : x$4;
	};
	line.y = function(_) {
		return arguments.length ? (y$4 = typeof _ === "function" ? _ : constant_default$2(+_), line) : y$4;
	};
	line.defined = function(_) {
		return arguments.length ? (defined = typeof _ === "function" ? _ : constant_default$2(!!_), line) : defined;
	};
...
function area_default(x0, y0, y1) {
	var x1 = null, defined = constant_default$2(true), context = null, curve = linear_default, output = null, path = withPath(area);
	x0 = typeof x0 === "function" ? x0 : x0 === void 0 ? x : constant_default$2(+x0);
	y0 = typeof y0 === "function" ? y0 : y0 === void 0 ? constant_default$2(0) : constant_default$2(+y0);
	y1 = typeof y1 === "function" ? y1 : y1 === void 0 ? y : constant_default$2(+y1);
	function area(data) {
	...
	area.x = function(_) {
		return arguments.length ? (x0 = typeof _ === "function" ? _ : constant_default$2(+_), x1 = null, area) : x0;
	};
	area.x0 = function(_) {
		return arguments.length ? (x0 = typeof _ === "function" ? _ : constant_default$2(+_), area) : x0;
	};
	area.x1 = function(_) {
		return arguments.length ? (x1 = _ == null ? null : typeof _ === "function" ? _ : constant_default$2(+_), area) : x1;
	};
	area.y = function(_) {
		return arguments.length ? (y0 = typeof _ === "function" ? _ : constant_default$2(+_), y1 = null, area) : y0;
	};
	area.y0 = function(_) {
		return arguments.length ? (y0 = typeof _ === "function" ? _ : constant_default$2(+_), area) : y0;
	};
	area.y1 = function(_) {
		return arguments.length ? (y1 = _ == null ? null : typeof _ === "function" ? _ : constant_default$2(+_), area) : y1;
	};
	...
	area.defined = function(_) {
		return arguments.length ? (defined = typeof _ === "function" ? _ : constant_default$2(!!_), area) : defined;
	};
...
function pie_default() {
	var value = identity_default$1, sortValues = descending_default$1, sort = null, startAngle = constant_default$2(0), endAngle = constant_default$2(tau), padAngle = constant_default$2(0);
	function pie(data) {
	...
	pie.value = function(_) {
		return arguments.length ? (value = typeof _ === "function" ? _ : constant_default$2(+_), pie) : value;
	};
	...
	pie.startAngle = function(_) {
		return arguments.length ? (startAngle = typeof _ === "function" ? _ : constant_default$2(+_), pie) : startAngle;
	};
	pie.endAngle = function(_) {
		return arguments.length ? (endAngle = typeof _ === "function" ? _ : constant_default$2(+_), pie) : endAngle;
	};
	pie.padAngle = function(_) {
		return arguments.length ? (padAngle = typeof _ === "function" ? _ : constant_default$2(+_), pie) : padAngle;
	};
	return pie;
}
//#endregion
...
function link(curve) {
	...
	link.x = function(_) {
		return arguments.length ? (x$3 = typeof _ === "function" ? _ : constant_default$2(+_), link) : x$3;
	};
	link.y = function(_) {
		return arguments.length ? (y$3 = typeof _ === "function" ? _ : constant_default$2(+_), link) : y$3;
	};
...
function Symbol$1(type, size) {
	...
	type = typeof type === "function" ? type : constant_default$2(type || circle_default$2);
	size = typeof size === "function" ? size : constant_default$2(size === void 0 ? 64 : +size);
	function symbol() {
		let buffer;
		if (!context) context = buffer = path();
	...
	symbol.type = function(_) {
		return arguments.length ? (type = typeof _ === "function" ? _ : constant_default$2(_), symbol) : type;
	};
	symbol.size = function(_) {
		return arguments.length ? (size = typeof _ === "function" ? _ : constant_default$2(+_), symbol) : size;
	};
...
function stack_default() {
	var keys = constant_default$2([]), order = none_default$1, offset = none_default, value = stackValue;
	function stack(data) {
	...
	stack.keys = function(_) {
		return arguments.length ? (keys = typeof _ === "function" ? _ : constant_default$2(Array.from(_)), stack) : keys;
	};
	stack.value = function(_) {
		return arguments.length ? (value = typeof _ === "function" ? _ : constant_default$2(+_), stack) : value;
	};
	stack.order = function(_) {
		return arguments.length ? (order = _ == null ? none_default$1 : typeof _ === "function" ? _ : constant_default$2(Array.from(_)), stack) : order;
	};
...
var emptyTween$1 = [];
function schedule_default$1(node, name, id, index, group, timing) {
	var schedules = node.__transition;
	if (!schedules) node.__transition = {};
	else if (id in schedules) return;
	create$1(node, id, {
...
function interrupt_default$3(name) {
	return this.each(function() {
...
function tween_default$1(name, value) {
	var id = this._id;
	name += "";
	if (arguments.length < 2) {
...
function interpolate_default$2(a, b) {
	var c;
...
function attr_default$2(name, value) {
	var fullname = namespace_default(name), i = fullname === "transform" ? interpolateTransformSvg : interpolate_default$2;
...
function attrTween_default$1(name, value) {
	var key = "attr." + name;
	if (arguments.length < 2) return (key = this.tween(key)) && key._value;
	if (value == null) return this.tween(key, null);
	if (typeof value !== "function") throw new Error();
...
function delay_default$1(value) {
	var id = this._id;
...
function duration_default$1(value) {
	var id = this._id;
...
function easeVarying_default$1(value) {
	if (typeof value !== "function") throw new Error();
...
function merge_default$2(transition) {
	if (transition._id !== this._id) throw new Error();
	for (var groups0 = this._groups, groups1 = transition._groups, m0 = groups0.length, m1 = groups1.length, m = Math.min(m0, m1), merges = new Array(m0), j = 0; j < m; ++j) for (var group0 = groups0[j], group1 = groups1[j], n = group0.length, merge = merges[j] = new Array(n), node, i = 0; i < n; ++i) if (node = group0[i] || group1[i]) merge[i] = node;
	for (; j < m0; ++j) merges[j] = groups0[j];
...
function on_default$2(name, listener) {
	var id = this._id;
...
function select_default$4(select) {
	var name = this._name, id = this._id;
	if (typeof select !== "function") select = selector_default(select);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) if ((node = group[i]) && (subnode = select.call(node, node.__data__, i, group))) {
		if ("__data__" in node) subnode.__data__ = node.__data__;
		subgroup[i] = subnode;
		schedule_default$1(subgroup[i], name, id, i, subgroup, get$1(node, id));
	}
...
function selectAll_default$3(select) {
	var name = this._name, id = this._id;
	if (typeof select !== "function") select = selectorAll_default(select);
	for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) {
		for (var children = select.call(node, node.__data__, i, group), child, inherit = get$1(node, id), k = 0, l = children.length; k < l; ++k) if (child = children[k]) schedule_default$1(child, name, id, k, children, inherit);
		subgroups.push(children);
		parents.push(node);
	}
...
function styleMaybeRemove$1(id, name) {
	var on0, on1, listener0, key = "style." + name, event = "end." + key, remove;
	return function() {
		var schedule = set$1(this, id), on = schedule.on, listener = schedule.value[key] == null ? remove || (remove = styleRemove$2(name)) : void 0;
		if (on !== on0 || listener0 !== listener) (on1 = (on0 = on).copy()).on(event, listener0 = listener);
		schedule.on = on1;
	};
}
function style_default$2(name, value, priority) {
	var i = (name += "") === "transform" ? interpolateTransformCss : interpolate_default$2;
...
function styleTween_default$1(name, value, priority) {
	var key = "style." + (name += "");
	if (arguments.length < 2) return (key = this.tween(key)) && key._value;
	if (value == null) return this.tween(key, null);
	if (typeof value !== "function") throw new Error();
...
function textTween_default$1(value) {
	var key = "text";
	if (arguments.length < 1) return (key = this.tween(key)) && key._value;
	if (value == null) return this.tween(key, null);
	if (typeof value !== "function") throw new Error();
...
function transition_default$3() {
	var name = this._name, id0 = this._id, id1 = newId$1();
	for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) {
		var inherit = get$1(node, id0);
		schedule_default$1(node, name, id1, i, group, {
			time: inherit.time + inherit.delay + inherit.duration,
			delay: 0,
			duration: inherit.duration,
			ease: inherit.ease
...
Transition$1.prototype = transition.prototype = {
	...
	on: on_default$2,
	attr: attr_default$2,
	attrTween: attrTween_default$1,
	style: style_default$2,
	styleTween: styleTween_default$1,
	text: text_default$3,
	textTween: textTween_default$1,
	remove: remove_default$2,
	tween: tween_default$1,
	delay: delay_default$1,
	duration: duration_default$1,
	ease: ease_default$1,
	easeVarying: easeVarying_default$1,
	end: end_default$1,
...
function transition_default$2(name) {
	var id, timing;
	if (name instanceof Transition$1) id = name._id, name = name._name;
	else id = newId$1(), (timing = defaultTiming$1).time = now(), name = name == null ? null : name + "";
	for (var groups = this._groups, m = groups.length, j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) schedule_default$1(node, name, id, i, group, timing || inherit$1(node, id));
...
selection.prototype.interrupt = interrupt_default$3;
selection.prototype.transition = transition_default$2;
//#endregion
//#region node_modules/d3/node_modules/d3-transition/src/active.js
var root$1 = [null];
function active_default(node, name) {
	var schedules = node.__transition, schedule, i;
	if (schedules) {
		name = name == null ? null : name + "";
		for (i in schedules) if ((schedule = schedules[i]).state > 1 && schedule.name === name) return new Transition$1([[node]], root$1, name, +i);
	}
	return null;
}
var namespaces_default$1 = {
	svg: "http://www.w3.org/2000/svg",
	xhtml: "http://www.w3.org/1999/xhtml",
	xlink: "http://www.w3.org/1999/xlink",
	xml: "http://www.w3.org/XML/1998/namespace",
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/namespace.js
function namespace_default$1(name) {
	var prefix = name += "", i = prefix.indexOf(":");
	if (i >= 0 && (prefix = name.slice(0, i)) !== "xmlns") name = name.slice(i + 1);
	return namespaces_default$1.hasOwnProperty(prefix) ? {
		space: namespaces_default$1[prefix],
		local: name
	} : name;
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/creator.js
...
function creator_default$1(name) {
	var fullname = namespace_default$1(name);
	return (fullname.local ? creatorFixed : creatorInherit)(fullname);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selector.js
function none() {}
function selector_default$1(selector) {
	return selector == null ? none : function() {
		return this.querySelector(selector);
	};
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/select.js
function select_default$3(select) {
	if (typeof select !== "function") select = selector_default$1(select);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = new Array(n), node, subnode, i = 0; i < n; ++i) if ((node = group[i]) && (subnode = select.call(node, node.__data__, i, group))) {
		if ("__data__" in node) subnode.__data__ = node.__data__;
		subgroup[i] = subnode;
	}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/array.js
function array(x) {
	return x == null ? [] : Array.isArray(x) ? x : Array.from(x);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selectorAll.js
function empty() {
	return [];
}
function selectorAll_default$1(selector) {
	return selector == null ? empty : function() {
		return this.querySelectorAll(selector);
	};
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/selectAll.js
...
function selectAll_default$2(select) {
	...
	else select = selectorAll_default$1(select);
	for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) {
		subgroups.push(select.call(node, node.__data__, i, group));
		parents.push(node);
	}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/matcher.js
function matcher_default$1(selector) {
	return function() {
		return this.matches(selector);
	};
}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/selectChild.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/selectChildren.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/filter.js
function filter_default$1(match) {
	if (typeof match !== "function") match = matcher_default$1(match);
	for (var groups = this._groups, m = groups.length, subgroups = new Array(m), j = 0; j < m; ++j) for (var group = groups[j], n = group.length, subgroup = subgroups[j] = [], node, i = 0; i < n; ++i) if ((node = group[i]) && match.call(node, node.__data__, i, group)) subgroup.push(node);
	return new Selection$1(subgroups, this._parents);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/sparse.js
function sparse_default(update) {
	return new Array(update.length);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/enter.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/constant.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/data.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/exit.js
function exit_default() {
	return new Selection$1(this._exit || this._groups.map(sparse_default), this._parents);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/join.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/merge.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/order.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/sort.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/call.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/nodes.js
function nodes_default() {
	return Array.from(this);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/node.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/size.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/empty.js
function empty_default() {
	return !this.node();
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/each.js
function each_default(callback) {
	for (var groups = this._groups, j = 0, m = groups.length; j < m; ++j) for (var group = groups[j], i = 0, n = group.length, node; i < n; ++i) if (node = group[i]) callback.call(node, node.__data__, i, group);
	return this;
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/attr.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/window.js
function window_default$1(node) {
	return node.ownerDocument && node.ownerDocument.defaultView || node.document && node || node.defaultView;
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/style.js
...
function styleValue$1(node, name) {
	return node.style.getPropertyValue(name) || window_default$1(node).getComputedStyle(node, null).getPropertyValue(name);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/property.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/classed.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/text.js
function textRemove() {
	this.textContent = "";
}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/html.js
function htmlRemove() {
	this.innerHTML = "";
}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/raise.js
function raise() {
	if (this.nextSibling) this.parentNode.appendChild(this);
}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/lower.js
function lower() {
	if (this.previousSibling) this.parentNode.insertBefore(this, this.parentNode.firstChild);
}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/append.js
function append_default(name) {
	var create = typeof name === "function" ? name : creator_default$1(name);
	return this.select(function() {
		return this.appendChild(create.apply(this, arguments));
	});
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/insert.js
function constantNull() {
	return null;
}
function insert_default(name, before) {
	var create = typeof name === "function" ? name : creator_default$1(name), select = before == null ? constantNull : typeof before === "function" ? before : selector_default$1(before);
	return this.select(function() {
		return this.insertBefore(create.apply(this, arguments), select.apply(this, arguments) || null);
	});
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/remove.js
function remove() {
	var parent = this.parentNode;
	if (parent) parent.removeChild(this);
}
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/clone.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/datum.js
function datum_default(value) {
	return arguments.length ? this.property("__data__", value) : this.node().__data__;
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/on.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/dispatch.js
function dispatchEvent(node, type, params) {
	var window = window_default$1(node), event = window.CustomEvent;
	if (typeof event === "function") event = new event(type, params);
	else {
		event = window.document.createEvent("Event");
		if (params) event.initEvent(type, params.bubbles, params.cancelable), event.detail = params.detail;
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/iterator.js
function* iterator_default() {
	for (var groups = this._groups, j = 0, m = groups.length; j < m; ++j) for (var group = groups[j], i = 0, n = group.length, node; i < n; ++i) if (node = group[i]) yield node;
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/selection/index.js
var root = [null];
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/select.js
function select_default$2(selector) {
	return typeof selector === "string" ? new Selection$1([[document.querySelector(selector)]], [document.documentElement]) : new Selection$1([[selector]], root);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/sourceEvent.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-selection/src/pointer.js
function pointer_default$1(event, node) {
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/schedule.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/interrupt.js
function interrupt_default$2(node, name) {
	var schedules = node.__transition, schedule, active, empty = true, i;
	if (!schedules) return;
	name = name == null ? null : name + "";
	for (i in schedules) {
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/selection/interrupt.js
function interrupt_default$1(name) {
	return this.each(function() {
		interrupt_default$2(this, name);
	});
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/tween.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/interpolate.js
function interpolate_default$1(a, b) {
	var c;
	return (typeof b === "number" ? number_default$1 : b instanceof color ? rgb_default$1 : (c = color(b)) ? (b = c, rgb_default$1) : string_default$1)(a, b);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/attr.js
...
function attr_default(name, value) {
	var fullname = namespace_default$1(name), i = fullname === "transform" ? interpolateTransformSvg$1 : interpolate_default$1;
	return this.attrTween(name, typeof value === "function" ? (fullname.local ? attrFunctionNS : attrFunction)(fullname, i, tweenValue(this, "attr." + name, value)) : value == null ? (fullname.local ? attrRemoveNS : attrRemove)(fullname) : (fullname.local ? attrConstantNS : attrConstant)(fullname, i, value));
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/attrTween.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/delay.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/duration.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/ease.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/easeVarying.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/filter.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/merge.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/on.js
function start(name) {
	return (name + "").trim().split(/^|\s+/).every(function(t) {
		var i = t.indexOf(".");
		if (i >= 0) t = t.slice(0, i);
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/remove.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/select.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/selectAll.js
function selectAll_default$1(select) {
	var name = this._name, id = this._id;
	if (typeof select !== "function") select = selectorAll_default$1(select);
	for (var groups = this._groups, m = groups.length, subgroups = [], parents = [], j = 0; j < m; ++j) for (var group = groups[j], n = group.length, node, i = 0; i < n; ++i) if (node = group[i]) {
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/selection.js
var Selection = selection$1.prototype.constructor;
function selection_default() {
	return new Selection(this._groups, this._parents);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/style.js
...
function style_default(name, value, priority) {
	var i = (name += "") === "transform" ? interpolateTransformCss$1 : interpolate_default$1;
	return value == null ? this.styleTween(name, styleNull(name, i)).on("end.style." + name, styleRemove(name)) : typeof value === "function" ? this.styleTween(name, styleFunction(name, i, tweenValue(this, "style." + name, value))).each(styleMaybeRemove(this._id, name)) : this.styleTween(name, styleConstant(name, i, value), priority).on("end.style." + name, null);
}
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/styleTween.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/text.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/textTween.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/transition.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/end.js
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/transition/index.js
var id = 0;
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/selection/transition.js
var defaultTiming = {
	time: null,
	delay: 0,
	duration: 250,
...
//#endregion
//#region node_modules/d3-zoom/node_modules/d3-transition/src/selection/index.js
selection$1.prototype.interrupt = interrupt_default$1;
selection$1.prototype.transition = transition_default;
//#endregion
...
function zoom_default$1() {
	var filter = defaultFilter, extent = defaultExtent, constrain = defaultConstrain, wheelDelta = defaultWheelDelta, touchable = defaultTouchable, scaleExtent = [0, Infinity], translateExtent = [[-Infinity, -Infinity], [Infinity, Infinity]], duration = 250, interpolate = zoom_default$2, listeners = dispatch("start", "zoom", "end"), touchstarting, touchfirst, touchending, touchDelay = 500, wheelDelay = 150, clickDistance2 = 0, tapDistance = 10;
	...
	function wheeled(event, ...args) {
		if (!filter.apply(this, arguments)) return;
		var g = gesture(this, args).event(event), t = this.__zoom, k = Math.max(scaleExtent[0], Math.min(scaleExtent[1], t.k * Math.pow(2, wheelDelta.apply(this, arguments)))), p = pointer_default$1(event);
		if (g.wheel) {
	...
	function mousedowned(event, ...args) {
		...
		var currentTarget = event.currentTarget, g = gesture(this, args, true).event(event), v = select_default$2(event.view).on("mousemove.zoom", mousemoved, true).on("mouseup.zoom", mouseupped, true), p = pointer_default$1(event, currentTarget), x0 = event.clientX, y0 = event.clientY;
		nodrag_default(event.view);
		nopropagation(event);
		...
		function mousemoved(event) {
			...
			g.event(event).zoom("mouse", constrain(translate(g.that.__zoom, g.mouse[0] = pointer_default$1(event, currentTarget), g.mouse[1]), g.extent, translateExtent));
		}
		function mouseupped(event) {
	...
	function dblclicked(event, ...args) {
		if (!filter.apply(this, arguments)) return;
		var t0 = this.__zoom, p0 = pointer_default$1(event.changedTouches ? event.changedTouches[0] : event, this), p1 = t0.invert(p0), k1 = t0.k * (event.shiftKey ? .5 : 2), t1 = constrain(translate(scale(t0, k1), p0, p1), extent.apply(this, args), translateExtent);
		noevent_default(event);
	...
	function touchstarted(event, ...args) {
		...
		nopropagation(event);
		for (i = 0; i < n; ++i) {
			t = touches[i], p = pointer_default$1(t, this);
			p = [
				p,
