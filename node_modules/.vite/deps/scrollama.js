...
//#region node_modules/scrollama/build/scrollama.js
var require_scrollama = /* @__PURE__ */ __commonJSMin(((exports, module) => {
	(function(global, factory) {
		...
		function selectAll(selector, parent = document) {
			...
			else if (selector instanceof Element) return [selector];
		...
		function scrollama() {
			...
			function updateProgressObserver(step) {
				...
				const offset = off.value * factor;
				const options = {
					rootMargin: `${-offset + step.height}px 0px ${offset - h}px 0px`,
					threshold: createProgressThreshold(step.height, progressThreshold)
				};
			...
			const S = {};
			S.setup = ({ step, parent, offset = .5, threshold = 4, progress = false, once = false, debug = false, container = void 0, root = null }) => {
...
//#endregion
export default require_scrollama();
